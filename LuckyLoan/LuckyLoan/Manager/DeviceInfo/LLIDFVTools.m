 ...
 
{
    ...
    //测试用 清除keychain中的内容
    //[LLIDFVTools delete:KEY_USERNAME_PASSWORD];
    
    //读取账号中保存的内容
    NSMutableDictionary *readUserDataDic = (NSMutableDictionary *)[LLIDFVTools load:KEY_USERNAME];
    ...
    {//如果是第一次 肯定获取不到 这个时候就存储一个
        ...
        //进行存储 并返回这个数据
        [LLIDFVTools save:KEY_USERNAME data:needSaveDataDic];

...
//开始轮播（bannerModel对象:model必须含有url属性）
- (void)startCarouselWithBannerModelArray:(NSMutableArray *)modelArray {
//    NSMutableArray *imageArray = [NSMutableArray array];
//    for (RouteModel *model in modelArray) {
//        if (![LLTools isBlankString:model.url]) {
